...
export default function BookCard({id, nome, genero, autor, imagem = defaultImagem}) {
    return (
        <Link to={`/livro/${id}`} className={css.card + " col-12 col-md-5 col-lg-2 d-flex flex-column"}>
            <div 
                style={{
                    width: '100%',
                    height: '300px',
            ...
            <span className={css.title + " fw-bold fs-5 text-black"}>{nome}</span>
